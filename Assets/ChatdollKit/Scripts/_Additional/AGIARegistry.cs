        ...
        public static Dictionary<AnimationCollection, Dictionary<string, Animation>> AnimationCollections { get; } = new()
        {
            ...
            },
            {
                AnimationCollection.AGIA, new()
                {
                    ...
                    //Added
                    {"hijimage_ryoteage", new Animation("BaseParam", 40, 3.0f)},
                    {"hokoriotoshi", new Animation("BaseParam", 41, 3.0f)},
                    {"kami_totonoe", new Animation("BaseParam", 42, 3.0f)},
                    {"kangaeruhito", new Animation("BaseParam", 43, 3.0f)},
                    {"kaoyokonite", new Animation("BaseParam", 44, 3.0f)},
                    {"koshinite_yurayura", new Animation("BaseParam", 45, 3.0f)},
                    {"ryote_nobashi", new Animation("BaseParam", 46, 3.0f)},
                    {"ryotekumi_maenobashi", new Animation("BaseParam", 47, 3.0f)},
                    {"teawase_yurayura", new Animation("BaseParam", 48, 3.0f)},
                    {"tokei_check", new Animation("BaseParam", 49, 3.0f)},
                    {"udehiroge_kunekune", new Animation("BaseParam", 50, 3.0f)},
                    {"udekumi_purapura", new Animation("BaseParam", 51, 3.0f)},
                    {"udekumi_yurayura", new Animation("BaseParam", 52, 3.0f)},
                    {"urotae", new Animation("BaseParam", 53, 3.0f)},
                    {"urotae_ryotemae", new Animation("BaseParam", 54, 3.0f)},
                    {"waiwai", new Animation("BaseParam", 55, 3.0f)},
                }
            },
        };
